    ...
    return (
        <div >
            <Card className = "mb-3" style={{width: '30rem' , color : "#000"}}>
                ...
                <Button size = "lg" disabled = {loading} className = "mb-3 w-100" variant = "secondary" type = "Submit">
                Login
                </Button>
                ...
                <GoogleLoginButton disabled = {loading}  type = "Submit" onClick = {handleGoogleLogin}/>
